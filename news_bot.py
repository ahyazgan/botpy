...
_SCORE_SYSTEM = (
    ...
    "- impact: 1-10 BEKLENEN FİYAT HAREKETİ büyüklüğü (genel önem/ilginçlik DEĞİL). "
    "Soru şu: bu haber çıktıktan sonraki dakikalarda ilgili coin'in fiyatı NE KADAR "
    "oynar? (10 = anında sert hareket: hack, iflas, ETF onayı, büyük borsa listelemesi, "
    "yasak, dava; 1 = fiyatı kıpırdatmaz). ÖNEMLİ: genel makro/düzenleyici YORUM ve "
    "GÖRÜŞ haberlerini (Fed faiz görüşü/dot-plot, merkez bankası açıklaması, MiCA/SEC "
    "genel düzenleme yorumu, analist tahmini, 'olabilir/öngörülüyor' türü) düşük-orta "
    "impact ver — bunlar önemli görünse de tek bir coin'i anında sert hareket "
    "ettirmez, çoğu zaten fiyatlanmıştır. Somut+ani+coin-spesifik olaylar yüksek "
    "impact alır. Kaynak güvenilirliği, yorgunluğu ve başlık-gövde çelişkisi de bu "
    "skoru ayarlar.\n"
